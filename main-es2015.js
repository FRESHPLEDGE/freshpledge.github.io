...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n  <div *ngIf=\"!popup\">\n    <div style=\"padding-top:15px; padding-bottom:15px\">\n      <button (click)=\"addMethod()\" mat-raised-button color=\"primary\">\n        Add\n      </button>\n    </div>\n    <div>\n      <table class=\"table\">\n        <thead>\n          <tr>\n            <th scope=\"col\">Name</th>\n            <th scope=\"col\">Description</th>\n            <th scope=\"col\">Method Type</th>\n            <th scope=\"col\">Version</th>\n            <th scope=\"col\">Created By</th>\n            <th scope=\"col\">Created At</th>\n            <th scope=\"col\">Edit</th>\n            <th scope=\"col\">Delete</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr *ngFor=\"let m of method\">\n            <td>{{ m.Name }}</td>\n            <td>{{ m.Description }}</td>\n            <td>{{ m.MethodType }}</td>\n            <td>{{ m.Version }}</td>\n            <td>{{ m.CreatedBy }}</td>\n            <td>{{ m.CreatedAt }}</td>\n            <td>\n              <button (click)=\"editMethod(m)\" mat-raised-button color=\"primary\">\n                Edit\n              </button>\n            </td>\n            <td>\n              <button\n                (click)=\"deleteMethod(m)\"\n                mat-raised-button\n                color=\"primary\"\n              >\n                Delete\n              </button>\n            </td>\n          </tr>\n        </tbody>\n      </table>\n    </div>\n  </div>\n  <div *ngIf=\"popup\">\n    <div>\n      <div class=\"example-container\">\n        <div class=\"col-md-12\">\n          <mat-form-field style=\"width: 100%\">\n            <input [(ngModel)]=\"name\" name=\"n\" matInput placeholder=\"Name\" />\n          </mat-form-field>\n        </div>\n        <div class=\"col-md-12\">\n          <mat-form-field style=\"width: 100%\">\n            <textarea\n              [(ngModel)]=\"description\"\n              name=\"d\"\n              matInput\n              placeholder=\"Description\"\n            ></textarea>\n          </mat-form-field>\n        </div>\n        <div class=\"col-md-12\">\n          <mat-form-field style=\"width: 100%\">\n            <mat-select\n              [(ngModel)]=\"methodtype\"\n              name=\"m\"\n              placeholder=\"Method Type\"\n            >\n              <mat-option *ngFor=\"let l of list\" value=\"{{ l }}\">{{\n                l\n              }}</mat-option>\n            </mat-select>\n          </mat-form-field>\n        </div>\n        <div class=\"col-md-12\">\n          <mat-form-field style=\"width: 100%\">\n            <input\n              [(ngModel)]=\"version\"\n              name=\"v\"\n              matInput\n              placeholder=\"Version\"\n            />\n          </mat-form-field>\n        </div>\n        &nbsp; &nbsp;\n        <button\n          [disabled]=\"edit\"\n          (click)=\"addMethodSubmit()\"\n          mat-raised-button\n          color=\"primary\"\n        >\n          Add\n        </button>\n        &nbsp;\n        <button\n          [disabled]=\"!edit\"\n          (click)=\"saveEdit()\"\n          mat-raised-button\n          color=\"primary\"\n        >\n          Save Edit\n        </button>\n      </div>\n    </div>\n  </div>\n</div>\n");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _forecasting_method__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./forecasting-method */ "./src/app/forecasting-method.ts");
...
let AppComponent = class AppComponent {
    constructor() {
        this.popup = false;
        this.method = [];
        this.list = ["Cleansing", "Forecasting", "Interpolation", "Custom"];
        this.edit = false;
    }
    addMethod() {
        this.popup = true;
    ...
    editMethod(m) {
        ...
        this.methodtype = m.MethodType;
        this.version = m.Version;
        this.edit = true;
        this.lastEdit = m;
    }
    addMethodSubmit() {
        let temp = new _forecasting_method__WEBPACK_IMPORTED_MODULE_2__["ForecastingMethod"]();
        temp.Name = this.name;
        temp.Description = this.description;
        temp.MethodType = this.methodtype;
        temp.Version = this.version;
        temp.CreatedBy = "Admin";
        temp.CreatedAt = moment__WEBPACK_IMPORTED_MODULE_3__().format("h:mm a");
        this.method.push(temp);
        this.popup = false;
    }
    saveEdit() {
        let temp = new _forecasting_method__WEBPACK_IMPORTED_MODULE_2__["ForecastingMethod"]();
        ...
        temp.MethodType = this.methodtype;
        temp.Version = this.version;
        this.changeDesc(this.lastEdit, temp);
        this.popup = false;
    }
    deleteMethod(m) {
        this.method = this.method.filter(c => c != m);
    }
    changeDesc(value, desc) {
        for (var i in this.method) {
            if (this.method[i] == value) {
                this.method[i].Name = desc.Name;
                this.method[i].Description = desc.Description;
                this.method[i].MethodType = desc.MethodType;
                this.method[i].Version = desc.Version;
                break;
            }
        }
    }
...
/***/ "./src/app/forecasting-method.ts":
/*!***************************************!*\
  !*** ./src/app/forecasting-method.ts ***!
  \***************************************/
/*! exports provided: ForecastingMethod */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ForecastingMethod", function() { return ForecastingMethod; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
module.exports = __webpack_require__(/*! /Users/seanham/Desktop/forecasting/src/main.ts */"./src/main.ts");
